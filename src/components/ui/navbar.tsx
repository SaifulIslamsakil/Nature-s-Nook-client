    ...
    return (
        <nav>
            <div className=" bg-black space-y-1 p-2">
                <p className=" hidden lg:block text-orange-300">Free Standard Shipping for Orders Over $50. <span className=" underline">Learn More</span></p>
                <div className="  px-2 py-4 md:px-4 lg:p-5 text-white flex justify-between items-center gap-5">
                    ...
                    <div>
                        <p onClick={() => setMenuToggel(!menuToggel)} className=" lg:hidden text-white text-2xl"> {menuToggel ? <ImCross /> : <AiOutlineMenuFold />} </p>
                    </div>
                </div>
            </div>
            <div className="flex justify-between items-center text-black relative ">
                ...
                <div className={`${menuToggel ? "block" : "hidden"} w-full lg:hidden md:w-80  h-screen  bg-white shadow-2xl  absolute border p-5 z-50`}>
                    <Menu />
                </div>
