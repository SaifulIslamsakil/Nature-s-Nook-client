    ...
    return (
        <Carousel autoPlay={true}>
            <div>
                ...
                <div className='py-10 bg-black bg-opacity-60 w-[480px] absolute bottom-32 left-32 space-y-4 rounded-lg'>
            ...
            <div className=' relative'>
                ...
                <div className='py-10 bg-black bg-opacity-60 w-[480px] absolute bottom-32 right-32 space-y-4 rounded-lg'>
                    <h1 className=' text-yellow-500 text-3xl font-semibold'>Explore Your Destinantion</h1>
                    <h3 className='text-white text-xl'>Exprince In Live</h3>
                    <Button className=' bg-orange-500'>Shop now</Button>
                </div>
